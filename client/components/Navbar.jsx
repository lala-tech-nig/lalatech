...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-white md:bg-white/95 md:backdrop-blur-md px-6 py-3 md:py-4 transition-all border-b border-slate-100 shadow-sm">
