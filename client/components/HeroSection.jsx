    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-12 overflow-hidden bg-white">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center w-full">
                ...
                {/* Pill shaped badge */}
                <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#f89e35]/30 text-[#f89e35] bg-[#f89e35]/5 font-bold text-xs tracking-widest uppercase mb-10 transition-all duration-700 ease-out">
                    <span className="w-2 h-2 rounded-full bg-[#f89e35] animate-pulse"></span>
                    Powering African Innovation
                </div>

                {/* Main large heading */}
                <h1 className="text-5xl md:text-7xl lg:text-[5rem] font-black mb-8 tracking-tight text-slate-900 leading-[1.1] transition-all duration-700 ease-out">
                ...
                {/* Subtitle text */}
                <p className="text-lg md:text-xl text-slate-600 mb-12 leading-relaxed max-w-2xl mx-auto font-medium transition-all duration-700 ease-out">
                    {displayContent}
                </p>
